    ...
    func setupTableAndDataSource() {
        dataSource = [
            ...
            DXSimpleTableViewSectionInfo.init(clazzTitle: "Example of NSFontAttributeName（字体）", cellInfos: [
                DXSimpleTableViewCellInfo.init(titleAttributedText: self.attributedString(attributeName:NSFontAttributeName, attributeValue: UIFont.systemFont(ofSize: 14), text: "我是font为 14 的文字")),
                DXSimpleTableViewCellInfo.init(titleAttributedText: self.attributedString(attributeName:NSFontAttributeName, attributeValue: UIFont.systemFont(ofSize: 20), text: "我是font为 20 的文字")),
                DXSimpleTableViewCellInfo.init(titleAttributedText: self.attributedString(attributeName:NSFontAttributeName, attributeValue: UIFont.italicSystemFont(ofSize: 14), text: "我是font为 14 的 斜体 文字，中文有点问题")),  // FIXME: italic Chinese
                DXSimpleTableViewCellInfo.init(titleAttributedText: self.attributedString(attributeName:NSFontAttributeName, attributeValue: UIFont.italicSystemFont(ofSize: 14), text: "I'm italicSystemFont of size 14, perfect!")),
                DXSimpleTableViewCellInfo.init(titleAttributedText: self.attributedString(attributeName:NSFontAttributeName, attributeValue: UIFont.boldSystemFont(ofSize: 14), text: "我比他们都要粗，粗体 14"))
                ]),
            ...
            DXSimpleTableViewSectionInfo.init(clazzTitle: "Example of NSForegroundColorAttributeName（文字颜色）", cellInfos: [
                DXSimpleTableViewCellInfo.init(titleAttributedText: self.attributedString(attributeName: NSForegroundColorAttributeName, attributeValue: UIColor.red, text: "我是 红色 的文字")),
                DXSimpleTableViewCellInfo.init(titleAttributedText: self.attributedString(attributeName: NSForegroundColorAttributeName, attributeValue: UIColor.blue, text: "我是 蓝色 的文字")),
                DXSimpleTableViewCellInfo.init(titleAttributedText: self.attributedString(attributeName: NSForegroundColorAttributeName, attributeValue: UIColor.green, text: "我是 绿色 的文字")),
                DXSimpleTableViewCellInfo.init(titleAttributedText: self.attributedString(attributeName: NSForegroundColorAttributeName, attributeValue: UIColor.orange, text: "我是 橙色 的文字")),
            ...
            DXSimpleTableViewSectionInfo.init(clazzTitle: "Example of NSBackgroundColorAttributeName（背景色）", cellInfos: [
                DXSimpleTableViewCellInfo.init(titleAttributedText: self.attributedString(attributeName: NSBackgroundColorAttributeName, attributeValue: UIColor.red, text: "我的底色是 红色 的")),
                DXSimpleTableViewCellInfo.init(titleAttributedText: self.attributedString(attributeName: NSBackgroundColorAttributeName, attributeValue: UIColor.blue, text: "我的底色是 蓝色 的")),
                DXSimpleTableViewCellInfo.init(titleAttributedText: self.attributedString(attributeName: NSBackgroundColorAttributeName, attributeValue: UIColor.green, text: "我的底色是 绿色 的")),
                DXSimpleTableViewCellInfo.init(titleAttributedText: self.attributedString(attributeName: NSBackgroundColorAttributeName, attributeValue: UIColor.orange, text: "我的底色是 橙色 的")),
                DXSimpleTableViewCellInfo.init(titleAttributedText: self.attributedString(textArray: [
                        "就和那些",
                        "妖艳贱货",
                        "看起来",
